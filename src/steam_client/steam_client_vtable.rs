...
use crate::steam_client::steamworks_types::{
    ...
    SteamAPIWarningMessageHook_t, SteamIPAddress_t,
};
...
pub struct ISteamClientVTable {
    ...
    pub create_local_user:
        unsafe extern "C" fn(*mut ISteamClient, *mut HSteamPipe, EAccountType) -> HSteamUser,
    ...
    pub get_isteam_game_server: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ...
    pub get_isteam_matchmaking: unsafe extern "C" fn(
        *mut ISteamClient,
        ...
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamMatchmaking
    pub get_isteam_matchmaking_servers: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamMatchmakingServers
    ...
    pub get_isteam_user_stats: unsafe extern "C" fn(
        *mut ISteamClient,
        ...
        HSteamPipe,
        *const c_char,
    ) -> *mut ISteamUserStats, // ISteamUserStats
    pub get_isteam_game_server_stats: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamGameServerStats
    pub get_isteam_apps: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut ISteamApps, // ISteamApps
    pub get_isteam_networking: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamNetworking
    pub get_isteam_remote_storage: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamRemoteStorage
    pub get_isteam_screenshots: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamScreenshots
    pub get_isteam_game_search: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamGameSearch
    ...
    pub set_warning_message_hook:
        unsafe extern "C" fn(*mut ISteamClient, SteamAPIWarningMessageHook_t),
    ...
    pub get_isteam_controller: unsafe extern "C" fn(
        *mut ISteamClient,
        ...
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamController
    pub get_isteam_ugc: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamUGC
    pub get_isteam_app_list: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut ISteamAppList, // ISteamAppList
    pub get_isteam_music: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamMusic
    pub get_isteam_music_remote: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamMusicRemote
    pub get_isteam_html_surface: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamHTMLSurface
    pub deprecated_set_steam_api_cpost_api_result_in_process:
        unsafe extern "C" fn(*mut ISteamClient, Option<extern "C" fn()>),
    pub deprecated_remove_steam_api_cpost_api_result_in_process:
        unsafe extern "C" fn(*mut ISteamClient, Option<extern "C" fn()>),
    pub set_steam_api_ccheck_callback_registered_in_process:
        unsafe extern "C" fn(*mut ISteamClient, SteamAPI_CheckCallbackRegistered_t),
    pub get_isteam_inventory: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamInventory
    pub get_isteam_video: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamVideo
    pub get_isteam_parental_settings: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamParentalSettings
    pub get_isteam_input: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamInput
    pub get_isteam_parties: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamParties
    pub get_isteam_remote_play: unsafe extern "C" fn(
        *mut ISteamClient,
        HSteamUser,
        HSteamPipe,
        *const c_char,
    ) -> *mut c_void, // ISteamRemotePlay
